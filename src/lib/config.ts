...
export const allowedDomainsByCategory: Record<NewsCategory["id"], string[]> = {
  ...
  gaming: ["ign.com", "polygon.com", "theverge.com", "reuters.com"],
  "media-streaming": [
    "variety.com",
...
export const feedSources: FeedSource[] = [
  {
    ...
    format: "rss",
    tier: "core",
    matchDomains: ["bbc.com", "bbc.co.uk"],
  ...
  },
  {
    ...
    categoryIds: ["ai-technology", "gaming", "media-streaming", "product"],
    language: "en",
    credibilityWeight: 0.88,
    enabled: true
  },
  ...
  },
  {
    ...
    format: "rss",
    tier: "related",
    matchDomains: ["hollywoodreporter.com"],
    categoryIds: ["media-streaming"],
    language: "en",
  ...
  },
  {
    ...
    format: "rss",
    tier: "related",
    matchDomains: ["blog.coinbase.com", "coinbase.com"],
  ...
  },
  {
    ...
    categoryIds: ["ai-technology", "programming", "devops-cloud", "data-analytics", "product"],
    language: "en",
  ...
  },
  {
    ...
    format: "rss",
    tier: "discussion",
    matchDomains: ["reddit.com", "www.reddit.com"],
    categoryIds: ["ai-technology", "product", "crypto-digital-assets"],
    language: "en",
    credibilityWeight: 0.68,
    enabled: false
  }
];
